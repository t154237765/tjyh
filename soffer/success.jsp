...
.weui-form-preview__bd,.weui-form-preview__label{font-size:.7rem;color:#333;}
	...
	#iosDialog3 img,#iosDialog4 img{width: 2.5rem;margin-right: .2rem;display: inline-block;}
        ...
        .gongxi{color:#333;width:6rem;margin-top:.5rem;margin-bottom:.5rem;display:inline-block;font-size:.8rem;}
      	.cfrom{display:inline-block;background:#0066B3;border-radius:1rem;color:#fff;width:4rem;text-align:center;font-size:0.6rem;padding:2% 0%;}
    </style>
</head>
<body>
        ...
        <div class="c-content" style="background:#f2f1f1;">
			...
			<div class="weui-panel__bd c-leftimg-rightall c-m-b-10">
				<div class="weui-form-preview__bd">
	                ...
	                <div class="weui-form-preview__item">
	                    ...
	                    <span class="weui-form-preview__value">${ingot_num}锭</span>
	                </div>
	                <div class="weui-form-preview__item">
			...
			<div class="weui-panel__bd c-leftimg-rightall c-m-b-10">
				<div class="weui-form-preview__bd" style="text-align:center;">
	               <p class="c-f-s-14 hbcj">红包抽奖</p>
	               <div class="redblock">
	               		<img onclick="javascript:award(this);" alt="" src="${stax}/assets/images/reda.png">
	               		<img onclick="javascript:award(this);" alt="" src="${stax}/assets/images/reda.png">
	               		<img onclick="javascript:award(this);" alt="" src="${stax}/assets/images/reda.png">
	               </div>
	            </div>
                    ...
                    <div class="weui-cells weui-cells_form">
                        <div class="weui-cell" style="padding:0 5px;background: #fff;text-align: left;">
                            <div class="weui-cell__bd" style="max-height: 13rem;overflow-y: auto;text-align: center;margin: 0 auto;">
                                <img id="prizePic" src="${stax}/assets/images/red2.png" onclick="award(this);">
                            </div>
                        </div>
                    </div>
                    <p class="c-c-b gongxi">恭喜获得<br/><span id="prizeNum" class="c-c-r">2锭</span>津元宝</p>
                </div>
                <div class="weui-di">
                    <a href="javascript:;" class="weui-dialog__btn weui-dialog__btn_primary c-c-6 cfrom" onclick="">确定</a>
                </div>
                <p style="color:red;margin:3% 0%;">自2019年1月1日0点起，津元宝有效期为<br/>自津元宝获得日起90天</p>
            </div>
        </div>
            ...
            <div class="weui-dialog">
                <div class="weui-dialog__bd c-c-b c-f-s-16">
                    <div class="weui-cells weui-cells_form">
                        <div class="weui-cell" style="padding:0 5px;background: #fff;text-align: left;">
                            <div class="weui-cell__bd" style="max-height: 13rem;overflow-y: auto;text-align: center;margin: 0 auto;">
                                <img src="${stax}/assets/images/redb.png" onclick="award(this);">
                            </div>
                        </div>
                    </div>
                    <p class="c-c-b gongxi">很遗憾<br/>本次未中奖</p>
                </div>
                <div class="weui-dialog__ft">
                    <a href="javascript:;" class="weui-dialog__btn weui-dialog__btn_primary c-c-6" onclick="">确定</a>
                </div>
            </div>
        </div>
...
<script class="navbar js_show">
    $(function(){
        ...
        $(".weui-dialog__ft , .cfrom").on("click",function(){
        	$("#iosDialog3").hide();
        	$("#iosDialog4").hide();
        })
    });
...
function award(el) {
	...
	$.ajax({
		type: "GET",
		url: "${ctx}/soffer/award.json",
		data: "userId="+encodeURIComponent(localStorage.getItem("userId")) + "&orderNo=${order_no}"+"&r="+Math.random(),
		success: function(resp){
			...
			if (resp.errMsg && resp.errMsg != null) {
				...
				awarded = true;
				if (resp.prize == 0) {
					currEl.src = "${stax}/assets/images/redb.png";
					$("#iosDialog4").show();
				} else {
					currEl.src = "${stax}/assets/images/red" + resp.prize + ".png";
					$("#prizeNum").html(resp.prize + "锭");
					$("#prizePic").attr("src", "${stax}/assets/images/red" + resp.prize + ".png");
					$("#iosDialog3").show();
				}
			}
		},
