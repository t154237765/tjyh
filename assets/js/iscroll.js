...
// INSERT POINT: DEFAULTS
	...
	this.refresh();
	// var isccc = this;
	// setTimeout(function(){console.log("刷新");
	// 	isccc.refresh()
	// },700);
...
// INSERT POINT: _end
	...
	_resize: function () {
		...
		this.resizeTimeout = setTimeout(function () {console.log("refresh")
			that.refresh();
...
// INSERT POINT: _translate
	...
	_initIndicators: function () {
		...
		this.on('refresh', function () {
			if ( this.indicator1 ) {console.log("indicator1")
				this.indicator1.refresh();
			}

			if ( this.indicator2 ) {console.log("indicator2")
