...
(function(root, factory){
    ...
    var AppConfig = {
        ...
        // 唤起失败时的跳转链接
        FAILBACK: {
            ANDROID: "http://a.app.qq.com/o/simple.jsp?pkgname=com.ccb.shop.view&g_f=991653",
            IOS:"http://a.app.qq.com/o/simple.jsp?pkgname=com.ccb.shop.view&g_f=991653"
        },

        // Android apk 相关信息
        APK_INFO: {
            PKG: "com.ccb.shop.view",
    ...
    return {
        ...
        generateSchema: function(schema) {
            var loadingOpen = weui.loading('正在打开');
            setTimeout(function(){
                loadingOpen.hide();
            },3000)
            ...
            if (isAndroidChrome) {
                schemaStr =  "intent://" + AppConfig.PROTOCAL +"#Intent;"  +
                             "scheme="   + schemaStr          + ";"+
                ...
                schemaStr = schemaStr + "://" + AppConfig.PROTOCAL;
            }
