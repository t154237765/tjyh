...
//         });
	    ...
	    setCountDown();
      	...
      	$('#shareTxt').val('我刚刚在建行手机商盟发起了一个${prod.prodName}的拼团，快来一起参团吧，点击'+
      				ctx+'/bannertuan/tuanad.do?ad=${tuan.tuanCode}查看');
    });
    
    function toHome(){
    	var bflag = "${payback}";
    	if(bflag){
    		//window.location.href = '${ctx}/bannertuan/indexhx.do?idcard='+localStorage.getItem("tjuserIdCard");
