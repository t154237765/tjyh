...
<head>
    ...
    <style type="text/css">
        ...
        .weui-navbar__item{background: #fff !important;color: #666;}
    ...
    .text1{width:12rem;height:10rem;background:#fff;border-radius:0.1rem;font-size:0.64rem;position:absolute;top:8rem;left:0;right:0;margin:auto;padding:3%;}
    </style>
</head>
<body>
...
<%--                 		<p class="c-c-r" style="display: none;">其中<span>${ingotnum30days}</span>锭30天内<label class="label">即将到期</label>，请注意使用哟！</p> --%>
				...
				<div class="weui-grids">
			        ...
			        <a href="javascript:toPage('tuan');" class="weui-grid">
			            ...
			            <p class="weui-grid__label">我的专享活动</p>
			            <span class="weui-grid__label">(专享活动)<br/>&nbsp;</span>
			        </a>
        ...
        <div class="weui-navbar weui-navbar-down">
            <div class="weui-navbar__item" onclick="toHome()">
                <div>
					<img style="width:1.2rem;margin:auto;margin-bottom:5%" src="${stax}/assets/images/newYear/icon-home-2.png" />
				</div>
				<p style="color:#666;">首页</p>
            </div>
            <div class="weui-navbar__item weui-bar__item_on">
                <div>
					<img style="width:1.1rem;margin:auto;margin-bottom:5%" src="${stax}//assets/images/newYear/icon-user-2.png" />
				</div>
				<p style="color:#CA403E;">个人中心</p>
            </div>
		<div class="slide"></div>
			<div class="slideTo">
        ...
        <div class="inform" style="display:none;">
	        ...
	        <div class="text1">
				...
				尊敬的天津惠用户：<br />
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您好！<br />
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;春节期间，天津惠平台所有活动均正常开展。2月4日-2月10日期间，在线客服暂停服务，2月11日起恢复正常。祝您春节愉快！<br />
	        </div>
        </div>
 	...
 	function register(){
        ...
        var loading = weui.loading('正在加载...');  //loading
 		$.ajax({
			...
			data: "phone="+phone+"&code="+ccode+"&bankId="+bankid+"&bankuid="+bankuid+"&iuphone="+iuphone+"&r="+Math.random(),
			success: function(resp){
				console.log(resp);
				loading.hide();
				if(resp.msg){
    		...
    		$.ajax({
        		...
        		success:function(resp){
        			if(resp.errMsg&&resp.errMsg!=""){
        				...
        				var scont = "您已确认"+resp.phone+"为邀请人，您尚未达成目标（在“天津惠”中成功完成4笔支付交易，已完成0笔），填写邀请人手机号后30天内，达成目标可获得津元宝奖励呦";
        				weui.alert(scont);
        	    		$(".sign2").hide();
        			}
        			console.log(resp);
