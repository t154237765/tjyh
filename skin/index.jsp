...
/* 		.swiper22{background: url(${stax}/assets/images/swiper8.jpg) no-repeat 50% top;background-size: contain;} */
   ...
   .sign1 , .sign2 ,.sign3{width:100%;height:100%;position:fixed;top:0;background:rgba(0,0,0,0.5);z-index:1111;}	
	...
	.shopMall div img{width:4.58rem;height:2.7rem;}
...
<!--          <p style="font-size:.8rem;text-align:center;margin-bottom:10px;">元旦节放假通知</p> -->
	 尊敬的客户：<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您好！<br />
&nbsp;&nbsp;&nbsp;&nbsp;国庆节假期将至，天津惠平台所有活动均正常开展。10月1日-10月7日期间，在线客服暂停服务，10月8日起恢复正常。祝各位国庆节假期愉快！<br />
&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red;">温馨提示：请注意津元宝到期时间，具体时间可到个人中心-查看明细进行查询。</span>
...
<!-- 						</div> -->
				...
				<div class="nav">
					<div id="c-a1">
						<img src="${stax}/assets/images/skin/pintuan.png">
						<p>拼团有礼</p>
					</div>
					<div id="c-a2">
...
<!-- 									<a class="aF" style="background: none;color: #333;font-size: 12px;padding: 0;margin:0;margin-left:-1px;">距离开始: </a> -->
				...
				<div class="shopMall">
					<div class="yzh">
						<img src="${stax}/assets/images/skin/shopMall-2.png">
					</div>
					<div id="house">
						<img src="${stax}/assets/images/skin/house-1.png">
					</div>
					<div id="card">
						<img src="${stax}/assets/images/skin/card-2.png">
					</div>			
				</div>
...
// 	  		$("#iosDialog3").hide();
    ...
    function fillSKPrd(data) {
    	...
    	$(".c-bdth-tap-sk").on("click",function(){
    		weui.alert('活动已结束，一元购将于10月18日来袭，敬请期待！');
//     		tosk($(this));
    	});
	}
	...
	function closeFun(){
		...
		if(msg == null){
			...
			var setDate1= new Date("2019/09/30 20:00:00").getTime();
			var setDate2= new Date("2019/10/07 23:59:59").getTime();
			if(setDate1 <= myDate){
