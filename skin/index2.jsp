...
/* 		.swiper22{background: url(${stax}/assets/images/swiper8.jpg) no-repeat 50% top;background-size: contain;} */
		.wangyin{background: url(${stax}/assets/images/wangyin.jpg) no-repeat 50% top;background-size: contain;}
		...
		.swiper27{background: url(${stax}/assets/images/qrqmJizi.jpg) no-repeat 50% top;background-size: 100% 100%;}
		...
		.jingdong{background: url(${stax}/assets/images/jingdong.jpg) no-repeat 50% top;background-size: 100% 100%;}
		.zhifubao{background: url(${stax}/assets/images/zhifubao.jpg) no-repeat 50% top;background-size: 100% 100%;}
        ...
        #local-special{width:88%;background:#F8F6F9;padding:0% 6%;}
    ...
    .restalert,.ginfoalert{width: 70%;height:30%;background: #fff;position: absolute;top:30%;left: 10%;z-index: 1000;border-radius: 5px;padding:1rem 1rem;}
    ...
    .rule{width:92%;height:92%;background:#fff;margin-top:44px;padding:4%;overflow:scroll; overflow-y: scroll;}
    .rule p{font-size:0.6rem;text-indent:2em;}
   .int{width:100%;border-top:2px solid #F2F1F1;}
   .int img{height:6.7rem;width:100%;}
   
   
   .sign1 , .sign2 ,.sign3{width:100%;height:100%;position:absolute;top:0;background:rgba(0,0,0,0.5);z-index:1111;}	
   /* .sign1 .Scont{width:70%;height:12rem;background:#fff;border-radius:0.2rem;position:absolute;top:28%;margin:auto;right:0;left:0;padding:0% 5%;} */
	.sign1 .Scont{width:70%;height:10rem;background:#fff;border-radius:0.2rem;position:fixed;top:28%;margin:auto;right:0;left:0;padding:0% 5%;}
	...
	.user{font-size:0.24rem;color:#fff;background:#FF7E5E;padding:1%;width:3rem;border-radius:0.5rem;font-weight:bold;text-align:center;position:absolute;top:0.4rem;letter-spacing:0.1rem;right:1rem;}
	...
	.nav img{width:2.368rem;height:2.368rem;margin:auto;}
	.nav p{font-size:0.64rem;}
	.shopMall{width:14.08rem;margin:auto;display:flex;align-items:center;justify-content:space-between;margin-bottom:0.5rem;flex-wrap:wrap;}
	.shopMall div{width:6.87rem;margin-top:0.4rem;}
	.shopMall div img{width:6.87rem;height:3.285rem;}
	...
	#seckillArea .weui-flex-left{width:40%;height:100%;background:#F8F6F9;border-radius:0.3rem;padding:0% 4%;text-align:center;}
	...
	#seckillArea .weui-flex-right .limit-list{width:96%;height:44%;background:#F8F6F9;background:#F8F6F9;border-radius:0.3rem;padding:2%;}
 	#seckillArea .weui-flex-right .limit-list:nth-child(1){margin-bottom:7%;}
 	...
 	/* 签到 */
 	/* .new{position:fixed;right:-.2rem;top:17rem; cursor: pointer;} */
 	.new img{width:100%;}
 	
 	.set{position: fixed;width:100%;height:100%;z-index: 9999; background-color: rgba(0,0,0,0.5);}
 	.set img{width:100%;z-index:9999;border-radius: .5rem;margin: auto;margin-top:32%;}
</style>
</head>
<body >
	...
	<div class="restalert" style="display:none;">
        ...
        <div class="text1">
         <p style="font-size:.8rem;text-align:center;margin-bottom:10px;">春节期间放假通知</p>
	 尊敬的天津惠客户：<br />
&nbsp;&nbsp;&nbsp;&nbsp;春节假日期间，天津惠平台所有活动均正常开展。<br />
&nbsp;&nbsp;&nbsp;&nbsp;1月24日期间，在线客服暂停服务，2月10日起恢复正常。祝您节日快乐！<br />
...
<!-- &nbsp;&nbsp;&nbsp;&nbsp;恭喜客户176****0350，实力打拼喜获4888锭津元宝锦鲤大奖（第06期），快来参加“幸运锦鲤”活动吧！<br /> -->
	...
	<div class="container" style="overflow-x: hidden;" id="wrapper">
				<!-- 签到按钮 -->
				<div class="new" style="display:block;position: absolute;right:0 ;top: 40%;z-index:999;width:3rem;" id="dance">
					<img src="${stax}/assets/images/skin/yearqian.png" >
				</div>
<!-- 				<div class="set" style="display:none;"> -->
<%-- 					<img src="${stax}/assets/images/year/mouse1.gif"> --%>
<!-- 				</div> -->
		<div id="dataArea">
			<div class="c-content" style="padding-bottom: 20px;">
				...
				<div class="swiper-container" id="mySwiper">
					...
					<div class="swiper-wrapper" id="lbtimg">
						<!--<div class="swiper-slide swiper26"></div>-->
						<!-- Slides -->
						<!--	金蜜蜂入金 -->
...
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 						<div class="swiper-slide wangyin"></div> -->
						<%
							SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd");
							long nowTime = System.currentTimeMillis();
							long startTime = df.parse("2020-01-22").getTime();
							long endTime = df.parse("2020-03-01").getTime();
							System.out.println(nowTime+"+"+startTime+"+"+endTime);
							if(nowTime >= startTime && nowTime < endTime){%>
								<div class='swiper-slide swiper27'></div>
						<%	}%>
						<div class="swiper-slide swiper25"></div>
						<div class="swiper-slide zhifubao"></div>
						<div class="swiper-slide jingdong"></div>
				...
				<div class="c-index-hot mygoldbean" style="position:relative;">
					...
					<img class="goldbean" src="${stax}/assets/images/forjin.png" /> <span id="user_ingot_num">0</span><i class="weui-icon-info-circle icon-1"></i>&nbsp;
					<img class="heart" src="${stax}/assets/images/heart.png" style="vertical-align: sub"/> <span id="user_vitality_num">0</span>
					<i class="weui-icon-info-circle icon-2"></i>
				</div>
				...
				<div class="nav">
					<div id="c-a1">
						<img src="${stax}/assets/images/skin/jizi.jpg">
						<p>集字有礼</p>
					</div>
					<div id="c-a2">
						<img src="${stax}/assets/images/skin/item-2.png">
						<p>诗词大会</p>
					</div>
					<div id="c-a3">
						<img src="${stax}/assets/images/skin/item-3.png">
						<p>兑换专区</p>
					</div>
					<div id="c-a4">
						<img src="${stax}/assets/images/skin/item-4.png">
						<p>专享活动</p>
					</div>
				</div>			
...
<!-- 				</div> -->
				<div class="shopMall">
					<div id="hotShop">
						<img src="${stax}/assets/images/firstShop.png">
					</div>
					<div class="yzh">
						<img src="${stax}/assets/images/shopMall.png">
					</div>
					<div id="house">
						<img src="${stax}/assets/images/house.png">
					</div>
					<div id="card">
						<img src="${stax}/assets/images/card.png">
					</div>			
				</div>
				...
				<div id="c-block-bottom" style="width:100%;height:2rem;background:#F8F6F9;"></div>
...
<!-- 		领取津元宝 -->
		...
		<div id="reg">
	        ...
	        <div class="rule" style="overflow-y:scroll">
	    	...
	    	$.ajax({
	    		...
	    		success:function(resp){
	    			...
	    			if(images.length > 0){
	    				...
	    				$("#mySwiper .swiper-slide:nth-of-type(1)").before(img)
...
//     	}
	...
	$(".icon-1").on("click",function(){
		weui.alert("请注意津元宝到期时间，具体时间可到个人中心-查看明细进行查询。");
	})
...
//         });
	  ...
	  //信用卡专区
		...
		/* 一元购  */
		$("#hotShop").on("click",function(){
			goPage("hotShop");
		})
		$(".wangyin").on("click",function(){
			bannerClickLog("网银话费大作战");
			goPage("wangyin")
		})
...
//   			isingotshop();
  		...
  		}else if(flag == 'wangyin'){
  			window.location.href = "${ctx}/jsp/wangyin1.jsp";
  		}else if(flag == 'use'){
...
//   			weui.alert("活动暂未开放，请稍后再试");
  		...
  		}else if(flag=="jizibanner"){
  			//weui.alert("活动时间为2020年1月22日-2月8日哟，敬请期待！")
  			window.location.href = "${ctx}/gatherwordvert/index.do?userId="+encodeURIComponent(localStorage.getItem("userId"));
  		}else if(flag == "jmfDetail"){
  			window.location.href = "${ctx}/jsp/game/stocks.jsp";
  		}else if(flag == "yearQian"){
  			window.location.href = "${ctx}/sign/index.do?userId="+encodeURIComponent(localStorage.getItem("userId"));
  		}else if(flag == "house"){
  			window.location.href = "${ctx}/loan/index.json";
  		}else{
  			comingsoon();
  		}
...
//   		var slid ="";
// 		var nowDate = 0;
// 		var startTime = new Date("2020,01,22 00:00:00").getTime();
// 		var endTime = new Date("2020,02,09 00:00:00").getTime();
// 		if(nowDate >= startTime && nowDate < endTime){
// 			slid = $("<div class='swiper-slide swiper27'></div>");
// 			$("#lbtimg").prepend(slid);
// // 			console.log(slid);
// 		}
// 	}
	...
	//指定时间关闭、开启该功能；
	 function closeFun(){
	  ...
	  if(msg == null){
	   ...
	   var setDate1= new Date("2020/01/20 00:00:00").getTime();
	   var setDate2= new Date("2020/02/10 09:00:00").getTime();
	   if(setDate1 <= myDate){
...
// 			sessionStorage.setItem("msg","123");
// 			var myDate = new Date().getTime();
// 			var setDate1= new Date("2020/01/15 00:00:00").getTime();
// 			var setDate2= new Date("2020/01/31 09:00:00").getTime();
// 			if(setDate1 <= myDate){
// 				$(".set" ).show();				
   ...
   /*   function showPop(){
    ...
    function hidePop() {
        ...
        if(isiOS) {
		 ...
		 var div1 = document.querySelector('#dance');
 			//限制最大宽高，不让滑块出去
