...
<head>
    ...
    <style type="text/css">
    	...
    	.pk-wrapper{padding:4.8rem 1rem 1rem;top:0;}
        ...
        .actPrizeImg img{width:2rem;margin: 0 auto;}
			...
			<div class="pk-wrapper">
                <div class="actPrize c-t-a-l c-m-b-10">
                    ...
                    <div class="actPrizeImg">
                        <div>
                            <img src="${stax}/assets/images/jinyb1.jpg">
                            <p>津元宝</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="button-sp-area">
                    <a href="http://a.app.qq.com/o/simple.jsp?pkgname=com.chinamworld.main&fromcase=40003" class="weui-btn weui-btn_plain-primary" style="line-height: 1.2">进入/下载建行手机银行APP</a>
                </div>
            </div>
		</div>
