    ...
    <div class="container" style="margin-top:44px;background:#fff;">
        ...
        <div class="c-content">
			...
			<div class="pk-wrapper1">
                <p id="myposcon" style="font-size: .7rem;font-weight:bold;"><img src="${stax}/assets/images/rangestar.png" style="width:1rem;height: 1.3rem;display: inline-block;">我的本月排名：<span id="myposnum" style="color:#ffa200">28</span></p>
                <div class="listrange">
                	<div class="rangeone">
...
<script>
   ...
   function goboard(){
	   window.location.href = '${ctx}/poem/poemBoard.do?userId='+encodeURIComponent(localStorage.getItem("userId"));
   }
