        ...
        <div class="c-content" style="padding-bottom: 50px;background:#f2f1f1;">
			...
			<div class="weui-panel__bd c-leftimg-rightall c-m-b-10" style="padding:1rem;";>
				<p class="c-panel-image2">
								...
								&nbsp;&nbsp;&nbsp;1.活动时间：每周五10：00至24:00，限定商品数量，抢完为止<br>
								&nbsp;&nbsp;&nbsp;2.活动对象：大连分行手机银行用户专享<br>
								&nbsp;&nbsp;&nbsp;3.每期每位用户每款商品限抢购一次<br>
								&nbsp;&nbsp;&nbsp;4.活动中所抢购的商品码或充值类商品均以短信形式发送或充值到用户登录“惠滨城”平台时使用的手机号，
													用户也可通过个人中心→我的订单查看<br>
								&nbsp;&nbsp;&nbsp;5.充值类商品统一于活动结束的次周周一集中处理充值，<span style="color:red;">如月底月初遇到运营商集中结算时充值时间顺延</span><br>
								&nbsp;&nbsp;&nbsp;6.限时抢购活动中所有商品均不支持使用现金券<br>
								&nbsp;&nbsp;&nbsp;7.活动声明：活动过程中，不允许使用虚拟手机号注册天津惠并参加活动，参与者如出现作弊行为（如批量注册、虚假交易、恶意套利等）或使用外挂、插件及其他破坏活动规则，
													违背活动公平的方式，主办方有权取消您的交易资格及作弊订单，且有权取消您后续参与任意活动的权利，并追究法律责任<br>
								&nbsp;&nbsp;&nbsp;8.本活动由北京博雅融联科技有限公司提供技术支持及相关服务，并负责处理、解决本次活动的相关争议,客服电话：400-810-9200 <br>
                            </p>
	       	</div>
