...
<body>
    ...
    <div class="container">
        <div class="titleBar">
            ...
            <div class="titleBar-text am-text-truncate">拼团成功</div>
        </div>
        ...
        <div class="c-content" style="padding-bottom: 50px">
            ...
            <div class="weui-panel__bd c-leftimg-rightall c-m-b-10" style="position: relative;">
                ...
                <div href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg">
                    ...
                    <div class="weui-media-box__bd">
                        ...
                        <p class="weui-media-box__desc c-esp-desc"><span class="c-c-r c-m-r-5 c-f-s-16">￥${paramMap.prodPrice}</span>￥${paramMap.oldPrice}</p>
            ...
            <div class="c-card" style="display: none;">
                ...
                <p style="color:red; margin-left:2rem;">温馨提示：电子券码过期作废，恕不退换，敬请谅解！</p>
            </div>
