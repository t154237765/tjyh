        ...
        <div class="c-content" style="padding-bottom: 60px" id="lieb">
           <div class="weui-panel__bd picTxtList c-m-b-10">
            ...
            <div class="weui-panel__bd c-leftimg-rightall">
                <h3><i class="fa fa-user-o" aria-hidden="true"></i>别人在开团</h3>
                <div id="datalistDiv">
...
// 	var discountList = null;
    ...
    $(document).ready(function() {
	    ...
	    $('#viewTuanDiv').on('click', function(){
	    	...
	    	window.location.href = "${ctx}/pintuan/tuanlist.do?pid=${prod.id}";
	    });
		...
		if(!isNaN(prodNum)){
			if(parseInt(prodNum) > 0){
				$.ajax({
					...
					data: "detailId="+$('#detailId').val()+"&pid=${prod.id}"+"&bflag=1"+"&userId="+userId+"&userwphone="+localStorage.getItem("tjuserWPhone")+"&addrId="+addrId+"&bankId="+bankId
    ...
    /**返回首页**/
 	function toHome(){
    	if (actiCode == 'hx_branch') {
    		window.location.href = '${ctx}/pintuan/indexhx.do?uid='+userId;
    	} else {
