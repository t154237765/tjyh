...
<head>
    ...
    <link rel="stylesheet" href="${stax}/assets/qrqm/css/weui.min.css"/>
   ...
   <style type="text/css">
        ...
        .c-p-l{float: left;}
        .c-p-r{float: right;text-align: right;}
        .weui-media-box{clear: both;height: 3rem;}
        .weui-media-box div{width:90%;padding:2% 5%;}
...
// 			+"&userId="+encodeURIComponent(localStorage.getItem("uid")) + "&userphone="+encodeURIComponent(localStorage.getItem("userPhone"));
		...
		if(prodName.indexOf("话费") >= 0){
			$(".c-tishi").html("订购成功，系统将在24小时内充值至您登录活动的手机号内，请注意查收。");
		}else{
			$(".c-tishi").html("订购成功，系统将在24小时内将兑换码发送至您登录活动的手机号内，请注意查收。");
		}
</script>
</body>
</html>