...
<body>
    ...
    <div class="container" style="margin-top:44px;background:#fbfaf8;">
        ...
        <div class="c-content">
			...
			<img src="${stax}/assets/images/introjyb_02.jpg" onclick="javascript:goPage('sg');">
            <img src="${stax}/assets/images/introjyb_03.jpg" onclick="javascript:goPage('poem');">
            <img src="${stax}/assets/images/introjyb_04.jpg">
            <img src="${stax}/assets/images/introjyb_05.jpg">
            <img src="${stax}/assets/images/introjyb_06.jpg" onclick="javascript:goPage('ez');">
