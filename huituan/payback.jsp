...
//         	toShare('拼团', '我刚刚在建行手机商盟发起了一个${prod.prodName}的拼团，快来一起参团吧', 
//             		encodeURIComponent('http://tianjin.boyaunite.com/bannertuan/tuanad.do?ad=${tuan.tuanCode}'), 'http://tianjin.boyaunite.com/assets/images/pintuanfenxiang.jpg');
...
//       				ctx+'/huituan/tuanad.do?ad=${tuan.tuanCode}查看');
    });
    
    function toHome(){
    	var bflag = "${payback}";
    	if(bflag){
    		//window.location.href = '${ctx}/huituan/indexhx.do?idcard='+localStorage.getItem("tjuserIdCard");
