...
<div class="c-bread">
	<ol class="am-breadcrumb">
		<li>
			<a href="#" class="c-level-1">限时抢购</a>
		</li>
		<li>
			<a href="#" class="c-level-2">商品管理</a>
		</li>
		<li>
		...
		<table border="0">
			...
			<tr>
				...
				<td>
					...
					<span>图片尺寸：100*100</span>
				</td>
			</tr>
			<tr>
				<td style="width: 150px">详情图：</td>
				<td>
					<button type="button" class="am-btn am-btn-primary am-radius">选择图片</button>
					<input type="text" class="file" style="width: 260px;" value="未选择任何文件" />
					<span>图片尺寸：100*100</span>
	...
	//实现头部导航的切换
  	$('.c-bread li a').click(function(){
  		...
  		if(title == "广告管理"){
  			...
  			link = "${ctx}/jsp/system_tjh/page/limit/addShop.jsp";
  		}
