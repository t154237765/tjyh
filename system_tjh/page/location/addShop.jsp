...
<div class="c-bread">
	<ol class="am-breadcrumb">
		<li>
			<a href="#" class="c-level-1">本地特惠</a>
		</li>
		<li>
			<a href="#" class="c-level-2" style="color:#0A60A9;pointer-events:none;">添加商品</a>
		</li>
	</ol>
</div>

<div class="am-u-md-12">
	<form action="##" id="addlocationshopform" method="post">
		<table border="0">
			<tr>
...
<script type="text/javascript">
	...
	$("#save").click(function(){
		...
		if(check){
			$.ajax({
				url:'${ctx}/a/localspecialoffer/addproduct.do',
				type:'post',
				data:$('#addlocationshopform').serialize(),
