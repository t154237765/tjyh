...
<div class="c-bread">
	<ol class="am-breadcrumb">
		<li>
			<a href="#" class="c-level-1">广告管理</a>
		</li>
		<li>
			<a href="#" class="c-level-2" style="color: #0066b3;">创建广告</a>
		</li>
	</ol>
</div>
...
<div class="am-u-md-12">
	<from action="" >
		<table border="0">
			...
			<tr>
				<td style="width: 150px">广告链接：</td>
				<td><input type="text" /></td>
			</tr>
			
			<tr>
				<td colspan="2">广告内容：</td>
			</tr>
			<tr>
				<td colspan="2">
					<div>
	...
	//实现头部导航的切换
  	$('.c-bread li a').click(function(){
  		...
  		if(title == "广告管理"){
  			...
  			link = "${ctx}/jsp/system_tjh/page/advertising/createdAdver.jsp";
  		}
