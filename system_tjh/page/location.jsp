...
<div class="am-u-md-12">
	<div class="c-input">
		...
		<input type="text" class="doc-ipt-3 productname" style="width: 260px;" />
		...
		<button type="button" class="am-btn am-btn-primary am-radius am-fr locationbtn">搜索</button>
	</div>
</div>
<div class="am-u-md-12">
	...
	<button type="button" class="am-btn am-btn-primary am-radius am-fr datatable-btn2">+添加商品</button>
</div>
...
<script type="text/javascript">
	...
	var url = "${ctx}/a/localspecialoffer/showspecialofferproduct.json?round="+round;
	$(function(){
		initTable(url);
	});
	...
	$(".datatable-btn2").click(function(){
		$.ajax({
				url:"${ctx}/jsp/system_tjh/page/location/addShop.jsp",
				type:"get",
				data:{},
				dataType:"html",
	...
	function putaway(data){
		$.ajax({
			url:'${ctx}/a/localspecialoffer/updateproduct.do',
			type:'post',
	...
	function del(data){
		$.ajax({
			url:'${ctx}/a/localspecialoffer/delProduct.do',
			type:'post',
			data:'id='+data,
			success:function(resp){
				console.log(resp);
	...
	$(".locationbtn").click(function(){
		...
		url = "${ctx}/a/localspecialoffer/showspecialofferproduct.json?prodName="+prodName+"&startTime="+starttime+"&endTime="+endtime+"&round="+round;
		initTable(url);
	});
